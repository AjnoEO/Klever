...
def __parse_dsl_tag(
    ...
    :type on_click: Callable[[str], None] | Callable[[], None] | None
    :param substring_adapter: Функция адаптирующая строку в тэге для создания правильной ссылки,
    None по умолчанию
    :type substring_adapter: Callable[[str], str] | None, optional
    ...
    match tag:
        ...
        case "ref":
            tag_info["on_click"] = __adapt_on_click_func(
                on_click, substring, substring_adapter
            )
        case _:
