"""Функция для создания функции из функции и значений аргументов"""

from typing import Callable


def apply_arguments(func: Callable, *inserted_args, **inserted_kwargs) -> Callable:
    """Создаёт функцию, которая работает аналогично функции `func`,
    но с применением аргументов, указанных следом
